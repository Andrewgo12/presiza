        ...
        <div class="mt-8 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
            <div class="bg-white overflow-hidden shadow rounded-lg">
                ...
                <div class="bg-gray-50 px-5 py-3">
                    <div class="text-sm">
                        <a href="{{ route('analytics.users') }}" class="font-medium text-indigo-600 hover:text-indigo-500">
                            Ver detalles
                        </a>
                    </div>
                </div>
            ...
            <div class="bg-white overflow-hidden shadow rounded-lg">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-medium text-gray-900">{{ $stats['total_projects'] ?? 0 }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
                <div class="bg-gray-50 px-5 py-3">
                    <div class="text-sm">
                        <a href="{{ route('projects.index') }}" class="font-medium text-indigo-600 hover:text-indigo-500">
                            Ver detalles
                        </a>
                    </div>
                </div>
            ...
            <div class="bg-white overflow-hidden shadow rounded-lg">
                <div class="p-5">
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                <dt class="text-sm font-medium text-gray-500 truncate">Total Evidencias</dt>
                                <dd class="text-lg font-medium text-gray-900">{{ $stats['total_evidences'] ?? 0 }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
                <div class="bg-gray-50 px-5 py-3">
                    <div class="text-sm">
                        <a href="{{ route('analytics.evidences') }}" class="font-medium text-indigo-600 hover:text-indigo-500">
                            Ver detalles
                        </a>
                    </div>
                </div>
            ...
            <div class="bg-white overflow-hidden shadow rounded-lg">
                ...
                <div class="bg-gray-50 px-5 py-3">
                    <div class="text-sm">
                        <a href="{{ route('analytics.files') }}" class="font-medium text-indigo-600 hover:text-indigo-500">
                            Ver detalles
                        </a>
                    </div>
                </div>
...
function exportData() {
    ...
    window.location.href = `{{ route('analytics.export') }}?period=${period}&format=csv`;
}
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    new Chart(activityCtx, {
        ...
        data: {
            ...
            datasets: [{
                label: 'Actividad',
                data: @json($chartData['activity']['data'] ?? []),
