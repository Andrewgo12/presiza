                ...
                <div class="mt-6 grid grid-cols-1 gap-4">
                    <button type="button" 
                        ...
                        <div class="text-left">
                            ...
                            <div class="text-xs text-blue-700">admin@company.com / admin123</div>
                        </div>
                    </button>
                    ...
                    <button type="button" 
                        ...
                        <div class="text-left">
                            <div class="font-semibold">Usuario Regular</div>
                            <div class="text-xs text-green-700">user@company.com / user123</div>
                        </div>
                    </button>
                </div>
            </div>
...
function loginForm() {
    return {
        ...
        fillDemo(type) {
            if (type === 'admin') {
                this.form.email = 'admin@company.com';
                this.form.password = 'admin123';
            } else {
                this.form.email = 'user@company.com';
