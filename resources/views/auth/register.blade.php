                    ...
                    <div>
                        ...
                        <div class="mt-2">
                            <input id="first_name" 
                                   ...
                                   class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 @error('first_name') ring-red-500 focus:ring-red-500 @enderror"
                                   placeholder="Juan"
                    ...
                    <div>
                        ...
                        <div class="mt-2">
                            <input id="last_name" 
                                   ...
                                   class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 @error('last_name') ring-red-500 focus:ring-red-500 @enderror"
                                   placeholder="Pérez"
                                   value="{{ old('last_name') }}">
                        </div>
                        @error('last_name')
