...
<div class="flex min-h-full flex-1 flex-col justify-center py-12 sm:px-6 lg:px-8">
    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-[480px]">
        <div class="bg-white px-6 py-12 shadow sm:rounded-lg sm:px-12">
            <form class="space-y-6" action="<?php echo e(route('login')); ?>" method="POST" x-data="loginForm()">
                <?php echo csrf_field(); ?>
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <input id="email" 
                               ...
                               required 
                               x-model="form.email"
                               class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> ring-red-500 focus:ring-red-500 <?php unset($message);
                ...
                <div>
                    ...
                    <div class="mt-2 relative">
                        <input id="password" 
                               ...
                               class="block w-full rounded-md border-0 py-1.5 pr-10 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> ring-red-500 focus:ring-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="text-sm leading-6">
                        <a href="<?php echo e(route('password.request')); ?>" class="font-semibold text-indigo-600 hover:text-indigo-500">
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp1\htdocs\reportes\resources\views/auth/login.blade.php ENDPATH**/ ?>